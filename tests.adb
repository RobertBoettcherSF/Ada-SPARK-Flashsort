--  Standalone test suite for Flashsort (SPARK port).
...
is
   ...
   --  Uniform-ish: values spread across 1 .. Len.
   ...
   --  Clustered: C tight groups spread across [Lo, Hi].
   function Clustered
...
begin
   Put_Line ("Flashsort (SPARK) tests");
   Put_Line ("=======================");
   ...
   ---------------------------------------------------------------------
   Section ("4. Negatives and Integer extremes (class map)");
   ---------------------------------------------------------------------
   ...
   Check (Nat (Class_Divisor) = 10, "Class_Divisor is 10");
   ...
   ---------------------------------------------------------------------
   Section ("7. Clustered / gapped keys");
   ---------------------------------------------------------------------
   ...
   ---------------------------------------------------------------------
   Section ("9. Class-count thresholds (n around 10, 20, ...)");
   ---------------------------------------------------------------------
   --  m = max(2, n/10): n=2..19 → m=2; n=20 → m=2; n=30 → m=3; n=64 → m=6.
   Expect_Sorted ([4, 1], "n=2 m=2");
   Expect_Sorted ([3, 2, 1], "n=3 m=2");
   Expect_Sorted ([9, 8, 7, 6, 5, 4, 3, 2, 1], "n=9 m=2");
   Expect_Sorted (Uniform_Ish (10), "n=10 m=2");
   Expect_Sorted (Uniform_Ish (11), "n=11 m=2");
   Expect_Sorted (Uniform_Ish (19), "n=19 m=2");
   Expect_Sorted (Uniform_Ish (20), "n=20 m=2");
   Expect_Sorted (Uniform_Ish (21), "n=21 m=2");
   Expect_Sorted (Uniform_Ish (30), "n=30 m=3");
   Expect_Sorted (Uniform_Ish (64), "n=64 m=6");

   ---------------------------------------------------------------------
   Section ("10. Idempotence and edge patterns");
   ---------------------------------------------------------------------
   declare
